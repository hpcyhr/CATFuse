...
Changes from v25 (Round 2 — no semantic changes):
  - Hoisted per-call imports (`from catfuse.sparseflow.sparse_conv2d_kernel import ...`, `import triton`)
...
from catfuse.sparseflow.ops.static_zero_conv2d import make_zero_conv_output, ZERO_BACKEND_FAMILY  # noqa: F401

# ---------------------------------------------------------------------------
# Module-level kernel availability probe.
#
# Previously `_supports_triton()` did `import triton` on every forward() and
# each kernel call site did `from catfuse.sparseflow.sparse_conv2d_kernel import ...` per call. We now
