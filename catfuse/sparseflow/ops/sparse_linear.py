...
from catfuse.sparseflow.config import (
...
# `from catfuse.sparseflow.sparse_linear_kernel import ...` inside _ensure_buffers() and the forward
...
try:
    ...
    from catfuse.sparseflow.sparse_linear_kernel import _select_linear_block_m, sparse_linear_forward
...
class SparseLinear(nn.Module):
    ...
    def _collect_tile_group_diag(
        ...
        """
        from catfuse.sparseflow.sparse_linear_kernel import _select_linear_block_m
        from catfuse.sparseflow.sparse_helpers import (
            TILE_ZERO,
            TILE_SPARSE,
            TILE_DENSEISH,
            choose_group_size,
