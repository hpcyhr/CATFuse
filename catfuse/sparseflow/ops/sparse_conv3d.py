...
Round 5 cleanup (no semantic changes):
  - Hoisted `from catfuse.sparseflow.sparse_conv3d_kernel import sparse_conv3d_forward` out of the
...
try:
    ...
    from catfuse.sparseflow.sparse_conv3d_kernel import sparse_conv3d_forward
