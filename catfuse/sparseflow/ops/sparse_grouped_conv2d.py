...
from catfuse.sparseflow.config import PRESCAN_ACTIVITY_EPS, SPARSE_DENSE_RATIO_THRESHOLD
...
try:
    ...
    from catfuse.sparseflow.sparse_conv2d_kernel import _select_tile_sizes
    from catfuse.sparseflow.sparse_grouped_conv2d_kernel import sparse_grouped_conv2d_forward
