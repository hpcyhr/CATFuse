...
from catfuse.sparseflow.analyzer import ReplacementTarget, display_block_info
from catfuse.sparseflow.ops.sparse_conv2d import SparseConv2d
from catfuse.sparseflow.ops.sparse_attention_block import SparseAttentionBlock
from catfuse.sparseflow.ops.static_zero_conv2d import StaticZeroConv2d
from catfuse.sparseflow.ops.static_zero_linear import StaticZeroLinear
...
class ModuleReplacer:
    ...
    def _create_sparse_module(
        ...
        if op == "depthwise_conv2d":
            from catfuse.sparseflow.ops.sparse_depthwise_conv2d import SparseDepthwiseConv2d
        ...
        # ---- conv1d ----
        if op == "conv1d":
            from catfuse.sparseflow.ops.sparse_conv1d import SparseConv1d
        ...
        # ---- conv3d ----
        if op == "conv3d":
            from catfuse.sparseflow.ops.sparse_conv3d import SparseConv3d
        ...
        # ---- linear ----
        if op == "linear":
            from catfuse.sparseflow.ops.sparse_linear import SparseLinear
        ...
        # ---- matmul ----
        if op == "matmul":
            from catfuse.sparseflow.ops.sparse_matmul import SparseMatmul
            sparse = SparseMatmul(
                threshold=common_threshold,
                return_ms=common_return_ms,
                profile_runtime=common_profile_runtime,
        ...
        # ---- bmm ----
        if op == "bmm":
            from catfuse.sparseflow.ops.sparse_bmm import SparseBMM
            sparse = SparseBMM(
                threshold=common_threshold,
                return_ms=common_return_ms,
                profile_runtime=common_profile_runtime,
